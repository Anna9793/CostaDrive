...
-- Reservas pasadas (Ya finalizadas)
INSERT INTO RESERVAS (ID_CLIENTE, ID_VEHICULO, FECHA_INICIO, FECHA_FIN, FECHA_RESERVA, ESTADO_RESERVA)
VALUES 
(1, 1, DATE '2026-06-01', DATE '2026-06-05', DATE '2026-05-25', 'FINALIZADA'),
(2, 4, DATE '2026-06-10', DATE '2026-06-15', DATE '2026-06-01', 'FINALIZADA'),
(3, 7, DATE '2026-06-20', DATE '2026-06-25', DATE '2026-06-15', 'FINALIZADA');
...
INSERT INTO INCIDENCIAS (ID_RESERVA, DESCRIPCION, COSTE, DESTINO_COSTE, ESTADO_INCIDENCIA)
VALUES (2, 'Rotura de espejo lateral', 150.00, 'CLIENTE', 'ABIERTA');
